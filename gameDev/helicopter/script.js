...
// препятствия (их параметры)
const obstacleWidth = 65;
const obstacleHeight = 135;

// how fast the background move
const moveSpeed = 7;
...
// getImageData returns a date object which  is a flat array of every
// pixel of the canvas in the specified rect (x, y, width, height).
// every 4 indices of the array in a  single pixel's r,g,b,a values
...
function loop() {
    ...
    // any pixels that match the wall color. the wall has to be draw
